    ...
    >
        ...
        >
            <div v-if="!uploadedImage">
                ...
                >
                    <div class="font-semibold text-[15px] sn:mb-0 mb-1 text-gray-700 sm:w-[160px] sm:text-left text-center">
                        Profile Photo
                    </div>
                    ...
                    <div class="flex items-center justify-center sm:-mt-6">
                        <label for="image" class="relative cursor-pointer">
                            ...
                            <div class="absolute bottom-0 right-0 rounded-full bg-white shadow-xl border p-1 border-gray-300 inline-block w-[32px]">
                                <Icon class="-mt-1 ml-0.5" name="ph:pencil-simple-line-bold" size="17"/>
                            </div>
                        </label>
        ...
        >
            ...
            >
                ...
                <button
                    ...
                    class="flex items-center bg-[#8800FF] text-white border rounded-md ml-3 px-3 py-[6px]"
                >
