        ...
        <UploadLayout>
            <div class="w-full mt-[80px] mb-[40px] bg-white shadow-lg rounded-md py-6 md:px-10 px-4">
                <div>
                    ...
                    <div class="text-gray-400 mt-1">Post a video to tour account</div>
                </div>
                ...
                <div class="mt-8 md:flex gap-6">
                    ...
                    <div class="mt-4 text-[15px]">Select video to upload</div>
                    ...
                    <div class="px-2 py-1.5 mt-8 text-white text-[15px] w-[80%] bg-[#8800ff] rounded-sm">
                        Select file
                    </div>
                    <input 
                        ref="file"
                ...
                <img class="absolute z-20 pointer-events-none"  src="~/assets/images/mobile-case.png" alt="">
                <img class="absolute right-4 bottom-6 z-20" width="16"  src="~/assets/images/logo-w.png" alt="">
                <video 
                    autoplay
                    loop
                    muted
            ...
            <div class="mt-4 mb-6">
                <div class="flex bg-[#F8F8F8] py-4 px-6">
                    <Icon name="mdi:box-cutter-off" class="mr-4" size="20"></Icon>
                    <div>
                    <div class="text-semibold text-[15px] mb-1.5">Divide videos and edit</div>
                    <div class="text-semibold text-[13px] text-gray-400">
                        You can quickly divide videos into multiple parts, remove redundant parts and turn into portrait videos
                    </div>
                </div>

                <div class="flex justify-end max-w-[130px] w-full h-full text-center my-auto">
                    <button class="px-8 py-1.5 text-white text-[15px] bg-[#8800FF] rounded-sm">
                        Edit
                    </button>
                </div>
            </div>
